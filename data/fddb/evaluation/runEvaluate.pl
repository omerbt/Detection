...
my $GNUPLOT = "gnuplot"; 
# where the binary is
my $evaluateBin = "data/fddb/evaluation/evaluate";#"/home/wolf/adampolyak/fddb/evaluation/evaluate";
# where the images are
my $imDir = "data/fddb/images/";#"/home/wolf/adampolyak/fddb/images/";
# where the folds are
my $fddbDir = "data/fddb/FDDB-folds"; #"/home/wolf/adampolyak/fddb/FDDB-folds";
# where the detections are
my $detDir = $ARGV[0]; 
###########################

my $detFormat = 1; # 0: rectangle, 1: ellipse 2: pixels
